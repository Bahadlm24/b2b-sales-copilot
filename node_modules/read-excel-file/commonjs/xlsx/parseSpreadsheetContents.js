...
function getSheetRelationId(sheet, sheets) {
  if (typeof sheet === 'string') {
    ...
    throw new _SheetNotFoundError["default"]("Sheet \"".concat(sheet, "\" not found. Available sheets: ").concat(sheets.map(function (_ref3) {
      var name = _ref3.name;
      return "\"".concat(name, "\"");
    }).join(', ')));
  } else {
    ...
    throw new _SheetNotFoundError["default"]("Sheet number out of bounds: ".concat(sheet, ". Available sheets count: ").concat(sheets.length));
  }
}
